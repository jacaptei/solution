...
namespace JaCaptei.Model {
    ...
    public class MailAdmin {
        ...
        public string baseColor { get; set; } = "#0072ff";
        ...
        public MailAdmin() {
            ...
            nameSender  = Config.settings.mailServerFromName;
            emailSender = Config.settings.mailServerFromName + " <"+ Config.settings.mailServerFromEmail + ">";
            ...
            userFrom        = Config.settings.mailServerFromEmail;
            passwordFrom    = Config.settings.mailServerFromPassword; 
            smtpPort        = int.Parse(Config.settings.mailServerSmtpPort);
            smtpHost        = Config.settings.mailServerSmtpHost;
            enableSsl       = bool.Parse(Config.settings.mailServerEnableSsl);

            nameTo  = Config.settings.mailServerDefaultToName;
            emailTo = Config.settings.mailServerDefaultToEmail;
        ...
        private string buildMailBody() {
            ...
            string mailBody = "<html>"
                                    ...
                                    + "<body style='font-family: \"Segoe UI\",\"Roboto\",\"Calibri\",\"Trebuchet MS\", \"Verdana\", \"Helvetica\",\"Sans-Serif\";color:#64656e'>"
                                        + "<img src=\"" + baseURL + "/resources/images/header_mail_admin.png\"  width='240' style=\"display: block;width:240px\"  />" + "<br><br> "
                                        + "<div style='margin-left:10px'>"
                                             + message
                                        + "</div>"
                                        + "<br><br>"
                                        + "<div style='color:#131a2e;margin-left:10px'>"
                                             + "© JáCaptei Sistema Administrativo "+(Utils.Date.GetLocalDate().Year.ToString()) +"."
                                             + "<br><a href='https://admin.jacaptei.com.br' target='_blank'  style='color:#0072ff;text-decoration:underline;'>https://admin.jacaptei.com.br</a>"
                                        + "<br><br></div>"
                                    + "</body>"
                             + "</html>";
