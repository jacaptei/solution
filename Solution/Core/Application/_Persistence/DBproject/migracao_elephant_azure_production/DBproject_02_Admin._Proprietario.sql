...
insert into "Admin" (nome,"idTipoUsuario",apelido,senha,"tipoPessoa",cnpj,"cnpjNum",cpf,"cpfNum",email,status,ativo,token,"tokenNum","tokenUID",roles,gestor,god,disponivel) 
VALUES ('JACAPTEI ADMIN',3,'Jacaptei','MTgxMDk2NTQwMDAxMTM=','PJ','18.109.654/0001-13',18109654000113,'188.364.538-72',18836453872,'desenvolvimento@jacaptei.com.br','ATIVO',TRUE,'02190606-216212024-9d4486c7-bb8e-4edb-b611-81275edd0ee0-237488',14421060619022402,'UID-02190606-216212024-e5acafce-cbd2-4122-92df-aa19f7d1e628-474560','ADMIN_GOD',TRUE,TRUE,TRUE);
